...
// ---------- ab hier: abgeleitete, EXPLIZIT GETYPTE Exporte ----------
...
export const ALL_SPECIES: Species[] = Array.from(new Set(Object.values(SPECIES_ALIASES))).sort();

export const ALL_FAMILIES: string[] = Array.from(new Set(Object.values(FAMILY_ALIASES))).sort();

export const ALL_CANON_TAGS: string[] = Array.from(new Set(Object.values(CANON_TAG_ALIASES))).sort();
