...
/* =====================================================
   1) Reindex (keywords / keywordPrefixes / tagsLower)
   ===================================================== */
...
/* =====================================================
   3) Präzises Seeding (Unsplash) für Species/Family/Strain
   ===================================================== */
...
router.post('/seed/term-images', async (req, res) => {
  try {
    ...
    // optional: nicht strikt ablehnen, aber validieren
    if (
...
/* =====================================================
   4) BULK: alle bekannten Begriffe (Unsplash)
   ===================================================== */
...
/* =====================================================
   5) Bestehende Seeder/Utility-Routen (Unsplash + wipe)
   ===================================================== */
    ...
    for (const q of topics) {
      for (let page = 1; page <= pages; page++) {
        ...
        for (const ph of results) {
          ...
          if (banWords.some((w: string) => desc.includes(w))) continue;
...
/* =====================================================
   6) Neueste N Posts mit Tag versehen
   ===================================================== */
